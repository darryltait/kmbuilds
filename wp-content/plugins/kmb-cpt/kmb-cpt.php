<?php
/*
Plugin Name: AspenEye - CPT
Description: A clean and simple plugin to set up the Custom Post Types to be used on the site.
Version: 1.0
Author: Darryl
Author URI: mysite.com
*/
...
function create_service_cpt() {
	...
	$args = array(
		...
		'description' => __( 'Services offered', 'textdomain' ),
		'labels' => $labels,
		'menu_icon' => 'dashicons-hammer',
		'supports' => array('title', 'editor', 'excerpt', 'thumbnail', 'revisions', 'post-formats', 'custom-fields'),
		'taxonomies' => array(),
		'public' => true,
		'show_ui' => true,
		'show_in_menu' => true,
